...
describe('CreateListContent', () => {
  ...
  it('should create a new list if button is clicked and title and description are provided', async () => {
    render(<CreateListContent />);
  ...
  it('should create a new list if button is clicked and only title is provided', async () => {
    render(<CreateListContent />);
  ...
  it('should not create a new list if button is clicked and no title is provided', async () => {
    render(<CreateListContent />);
